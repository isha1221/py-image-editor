from tkinter import X, Toplevel, Button, RIGHT
import numpy as np
import cv2
...
class FilterFrame(Toplevel):
    def __init__(self, master=None):
        ...
        for btn in [self.negative_button, self.black_white_button, self.sepia_button,
                   self.emboss_button, self.gaussian_blur_button, self.median_blur_button]:
